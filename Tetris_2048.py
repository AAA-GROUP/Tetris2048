...
def start():
    ...
    while True:
        ...
        if stddraw.hasNextKeyTyped():
            ...
            elif key_typed == "space":  # if up key is pressed, drops automatically buy maximum droppable level
                a = 1
        ...
        # checks whether the mouse control option is on or not
        if is_mouse_on:
        ...
        # checks whether an unconnected tile exists
        ...
        if not success:
            ...
            # deletes the current tetromino that already has stopped
...
def display_game_menu(grid_height, grid_width):
    ...
    background_color = Color(240, 208, 170)
    button_color = Color(31, 160, 239)
    text_color = Color(205, 233, 247)
